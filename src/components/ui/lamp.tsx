  ...
  return (
    <LampContainer>
      ...
      >
        ...
        Lorem ipsum dolor sit amet, consectetur adipisicing elipassionate
        developers Lorem ipsum dolor sit amet, consectetur adipisicing
        elipassionate developers Lorem ipsum dolor sit amet, consectetur
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex  flex-col  justify-center overflow-hidden dark:bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
